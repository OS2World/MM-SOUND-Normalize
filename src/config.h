...
#define int8_t signed TYPE8
#define int16_t signed TYPE16
#define int32_t signed TYPE32
#define uint8_t unsigned TYPE8
#define uint16_t unsigned TYPE16
#define uint32_t unsigned TYPE32
